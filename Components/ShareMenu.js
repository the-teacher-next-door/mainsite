      ...
      <ul>
        ...
        <li>
          <a
            ...
            onClick={() => {
              window.open(
                `http://pinterest.com/pin/create/button/?url=${url}&media=https://bookriot.com/wp-content/uploads/2018/11/best-thanksgiving-books-for-kids.jpg&description=${props.title}&media=${props.mainImage}`,
                "pinterestShare",
